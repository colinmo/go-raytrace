...
#        When slice.xs ← intersections(intersection.i1, intersection.i2)
...
#        And intersection.i1 ← intersection(1, sphere.s)
#        And intersection.i2 ← intersection(2, sphere.s)
#        And slice.xs ← intersections(intersection.i2, intersection.i1)
#        When intersection.i ← hit(slice.xs)
...
#        And slice.xs ← intersections(intersection.i1, intersection.i2, intersection.i3, intersection.i4)
#        When intersection.i ← hit(slice.xs)
